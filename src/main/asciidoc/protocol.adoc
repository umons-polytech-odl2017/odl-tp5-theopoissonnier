...
Votre objectif est d'implémenter les classes du diagramme <<exercise1-classes>> et leurs méthodes.
...
Pour ce faire, implémentez l'interface `Comparable` dans la classe `Student`.
